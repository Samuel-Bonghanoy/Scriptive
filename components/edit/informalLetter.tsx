    ...
    <div className="flex h-[1056px] w-[816px] bg-white flex-col px-12 py-12 text-black gap-2 shadow-gray-700 shadow-md rounded-md">
      <div className="flex flex-col">
        <div className="flex flex-col justify-end">
          <h1 className="text-4xl font-bold self-end">John Smith</h1>
          <div className="flex flex-col">
            <p className="text-[1rem] self-end">+123-456-7890</p>
            <p className="text-[1rem] self-end">johnsmith@scriptive.com</p>
            <p className="text-[1rem] self-end">123 Anywhere St. Any City</p>
          </div>
        </div>

        <p className="text-[1rem] self-end pb-5">14th August 2026</p>
        <p className="text-[1rem] pb-2 font-semibold">Dear Recipient,</p>
        ...
        <p className="text-[1.15rem] pb-2 font-semibold">John Smith</p>
      </div>
    </div>
  );
}
